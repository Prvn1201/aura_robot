...
#include "ackermann_gazebo_plugins/traffic_light_plugin.hpp"
...
void TrafficLight::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf)
{
  ...
  this->msg.set_name(this->model->GetName() + "::traffic_light::visual");
  this->msg.set_parent_name(this->model->GetName() + "::traffic_light");
